# Generated by Django 3.1.1 on 2020-10-15 18:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('ENTERTAINMENT', 'Entertainment'), ('ELECTRONICS', 'Electronics'), ('HOME', 'Home'), ('HEALTH', 'Health'), ('PETS', 'Pets'), ('TOYS', 'Toys'), ('FASHION', 'Fashion'), ('SPORTS', 'Sports'), ('BABY', 'Baby'), ('TRAVEL', 'Travel')], max_length=64, null=True, verbose_name='Category')),
